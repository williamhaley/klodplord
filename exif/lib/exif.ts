function readExifValue(format: number, stream: any) {
  switch (format) {
...
function getBytesPerComponent(format: number) {
  switch (format) {
    case 1:
    case 2:
    case 6:
...
function readExifTag(tiffMarker: any, stream: any) {
...
function readIFDSection(tiffMarker: any, stream: any, iterator: any) {
...
function readHeader(stream: any) {
...
export default {
  ...
  SubIFD: 4,
  InteropIFD: 5,
  parseTags: function(stream: any, iterator: any) {
    var tiffMarker;
    try {
    ...
    var ifd0Stream = tiffMarker.openWithOffset(stream.nextUInt32()),
      IFD0 = this.IFD0;
    readIFDSection(tiffMarker, ifd0Stream, function(tagType: number, value: any, format: any) {
      switch (tagType) {
    ...
    if(subIfdOffset) {
      ...
      readIFDSection(tiffMarker, subIfdStream, function(tagType: any, value: any, format: any) {
        if(tagType === 0xA005) {
